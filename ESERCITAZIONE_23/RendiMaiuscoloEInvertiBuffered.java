...
class RendiMaiuscoloEInvertiBuffered {
	public static void main(String[] args){
		try{
			...
			BufferedWriter fileScrittura = new BufferedWriter(new FileWriter(nuovoFile));
